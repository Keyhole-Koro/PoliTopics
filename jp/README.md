...
- ドキュメントインデックス: `docs/jp/README.md`
- コードリーディングガイド: `docs/jp/00_code_reading_guide.md`
- システム概要: `docs/jp/system_overview.md`
- ビルド & ローカル環境ガイド: `docs/jp/build.md`

## リポジトリ構造

ルートリポジトリは3つのサブモジュールを結合し、統合された Dev Container、LocalStack インスタンス、ドキュメントを共有しつつ、それぞれが独立してデプロイ可能な状態を維持しています。
